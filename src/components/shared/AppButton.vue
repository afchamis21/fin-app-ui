...
<template>
  <button :type="props.type" :disabled="disabled" class="font-medium shadow p-3 rounded-md cursor-pointer flex transition-colors
    disabled:opacity-80 disabled:cursor-not-allowed" @click="emit('on-click')" :class="{
