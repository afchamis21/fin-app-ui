...
<template>
  <section class=" bg-gray-50 flex items-center justify-center px-6">
    <form class="bg-gray-100 shadow max-w-lg min-5-[40%] w-full rounded-lg p-4" @submit.prevent="handleLogin">
